...
export const translations = {
  nl: {
    ...
    traceability: {
      ...
      kpi: {
        coverage:  'Coverage oordeel',
        gaps:      'Open gaps',
        blockers:  'Build-ready blockers',
        objects:   'Gekoppelde objecten',
      },
      table: {
        domein:       'Domein',
        proces:       'Proces',
        useCase:      'Use case',
        dataObjecten: 'Data-objecten',
      ...
      detail: {
        heading:              'Detailpanel geselecteerde keten',
        chainLabel:           'Keten',
        status:               'Status',
        privacy:              'Privacygevoelig',
        buildImpact:          'Build-ready impact',
        eigenaar:             'Eigenaar',
        update:               'Laatste update',
        vervolgactie:         'Gekoppelde vervolgactie',
        yes:                  'Ja',
        no:                   'Nee',
        coverageProgress:     'Coverage voortgang',
        chain: ['Domein', 'Proces', 'Use case', 'Scherm', 'Tests'],
      },
      coverageLabels: {
        ok:       'ok',
        aandacht: 'Aandacht',
      ...
      footer: 'Demo-opmerking: B4C-SCR-010 v0.2 vervangt alleen de traceability mockup.',
      openLfv: 'Open LFV →',
    },
  ...
  en: {
    ...
    traceability: {
      ...
      detail: {
        heading:              'Detail panel — selected chain',
        chainLabel:           'Chain',
        status:               'Status',
        ...
        eigenaar:             'Owner',
        update:               'Last update',
        vervolgactie:         'Linked follow-up action',
        yes:                  'Yes',
        no:                   'No',
        coverageProgress:     'Coverage progress',
        chain: ['Domain', 'Process', 'Use case', 'Screen', 'Tests'],
      },
      coverageLabels: {
        ok:       'ok',
        aandacht: 'Attention',
      ...
      footer: 'Demo note: B4C-SCR-010 v0.2 replaces only the traceability mockup.',
      openLfv: 'Open LFV →',
    },
    readiness: {
      label:    'PMO & READINESS',
